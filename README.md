...
Designed within an agent-based market simulation (Flexemarkets), the bot **engages in reacive market-making**, accepting or rejecting trades based on dynamically
